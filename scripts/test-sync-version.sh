...
grep -q "<string>9.9.9</string>" "$T1/apps/macos/ClaudeDashboard/Info.plist" && ok "Info.plist bumped" || ko "Info.plist bumped"
...
SNAPSHOT="$(mktemp -d)"
cp "$T2/apps/macos/ClaudeDashboard/Info.plist" "$SNAPSHOT/"
