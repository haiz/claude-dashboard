class ClaudeDashboardCli < Formula
  ...
  url "https://github.com/haiz/claude-dashboard/releases/download/v1.10.1/claude-dashboard-cli.tar.gz"
  sha256 "e8b01d20d197a259f4cad351fadf227390126ff25dc8dc080c5fcb546981036f"
  version "1.10.1"
