class ClaudeDashboardCli < Formula
  ...
  url "https://github.com/haiz/claude-dashboard/releases/download/v1.4.1/claude-dashboard-cli.tar.gz"
  sha256 "1a9d9e68f86cd2a7a5da7ca2a87545534c3092359727ef8aac674774d8cd8ad4"
  version "1.4.1"
